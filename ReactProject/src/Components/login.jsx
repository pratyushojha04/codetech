    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <section className="form-container flex-grow flex justify-center items-center">
        <form action="" method="post" enctype="multipart/form-data" className="bg-white shadow-md p-8 rounded-lg max-w-md w-full">
          <h3 className="text-2xl font-semibold text-gray-900 mb-4">Login Now</h3>
          ...
          <input type="submit" value="Login Now" name="submit" className="btn bg-green-600 text-white py-2 px-4 rounded-lg w-full" />
        </form>
      </section>
