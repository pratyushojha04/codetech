...
import { FaSearch, FaBars, FaUser, FaSun, FaTimes, FaGraduationCap, FaUserGraduate, FaChalkboardTeacher, FaBriefcase, FaStar, FaStarHalfAlt } from 'react-icons/fa';
...
const About = () => {
  ...
  const [userDropdownOpen, setUserDropdownOpen] = useState(false); // Add state for user dropdown
    ...
    <div>
      ...
      <header className="bg-white shadow-md p-4 sticky top-0 z-50">
        <div className="flex justify-between items-center">
          ...
          {/* Search Form */}
          <form action="search.html" method="post" className={`relative ${searchOpen ? 'block' : 'hidden'} md:flex items-center bg-gray-200 rounded-lg p-3 w-1/2`}>
            <input
              type="text"
              name="search_box"
              required
              ...
              maxLength="100"
              className="p-2 border border-gray-300 rounded-md focus:outline-none bg-transparent text-gray-800 text-lg flex-grow"
            />
      ...
      <section className="about p-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="content">
            ...
            <Link to="/courses" className="inline-block bg-blue-500 text-white px-4 py-2 rounded-md mt-4">
              Our Courses
            </Link>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mt-8">
          ...
          <div className="box flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Brilliant Students</p>
            </div>
          </div>
          ...
          <div className="box flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Job Placement</p>
            </div>
          </div>
        </div>
      </section>
